...
if(args.indexOf('--target-browser') != -1){
  ...
  externals['../build/cs-transparent-acc-sdk.node.js'] = 'CSTransparentAccSDK'  
}else{
  ...
  externals['../build/cs-transparent-sdk.node.js'] = '../../build/cs-transparent-acc-sdk.node.js'
...
module.exports = {
  ...
  output: {
    ...
    library: "CSTransparentAccSDKTests",
