...
if(args.indexOf('--target-browser') != -1){
  ...
  outputFilename = 'cs-transparent-acc-sdk.sfx.min.js';
  target = 'web';
  libraryTarget = 'var'
  nodeModules = {};
  ...
  outputFilename = 'cs-transparent-acc-sdk.node.min.js'
...
module.exports = {
  entry: './lib/transparent-acc.ts',
  output: {
    path: path.join(__dirname, 'build'),
    filename: outputFilename,
    library: "CSTransparentAccSDK",
